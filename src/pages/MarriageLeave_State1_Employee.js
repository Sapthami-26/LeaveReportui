                ...
                <form onSubmit={handleSubmit} className="leaveForm-form-Marriage">
                    <div className="leaveForm-mainGrid-Marriage">
                        ...
                        <div className="leaveForm-fieldGroup-Marriage leaveForm-col-span-2-Marriage">
                            ...
                            <select id="leaveType" className="leaveForm-select-Marriage" value={leaveType} onChange={(e) => setLeaveType(e.target.value)}>
                         ...
                         <div className="leaveForm-fieldGroup-Marriage leaveForm-col-span-2-Marriage">
                             ...
                             <input id="fromDate" type="date" className="leaveForm-dateInput-Marriage" value={fromDate} onChange={(e) => setFromDate(e.target.value)} />
                         </div>

                        <div className="leaveForm-fieldGroup-Marriage leaveForm-col-span-2-Marriage">
                             <label htmlFor="toDate" className="leaveForm-label-Marriage">To Date</label>
                             <input id="toDate" type="date" className="leaveForm-dateInput-Marriage" value={toDate} onChange={(e) => setToDate(e.target.value)} />
                        </div>
                    </div>

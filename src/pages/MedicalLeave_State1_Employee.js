                ...
                <form onSubmit={handleSubmit} className="leaveForm-form-Medical">
                    <div className="leaveForm-mainGrid-Medical">
                        ...
                        <div className="leaveForm-fieldGroup-Medical leaveForm-col-span-2-Medical">
                            ...
                            <select id="leaveType" className="leaveForm-select-Medical" value={leaveType} onChange={(e) => setLeaveType(e.target.value)}>
                                <option>Medical Leave</option>
                            </select>
                        </div>
                        <div className="leaveForm-fieldGroup-Medical leaveForm-col-span-2-Medical">
                            <label htmlFor="fromDate" className="leaveForm-label-Medical">From Date</label>
                            <input id="fromDate" type="date" className="leaveForm-dateInput-Medical" value={fromDate} onChange={(e) => setFromDate(e.target.value)} />
                        </div>
                        
                        <div className="leaveForm-fieldGroup-Medical leaveForm-col-span-2-Medical">
                            <label htmlFor="toDate" className="leaveForm-label-Medical">To Date</label>
                            <input id="toDate" type="date" className="leaveForm-dateInput-Medical" value={toDate} onChange={(e) => setToDate(e.target.value)} />
                        </div>
                    </div>
